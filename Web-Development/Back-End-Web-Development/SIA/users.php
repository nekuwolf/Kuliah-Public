...
<?php 
    ...
    $baris=$conn->query( "SELECT * FROM users ");
                ...
                <div class="p-4 vh-100 bg-light">
                    <ul class="nav nav-pills" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="simple-tab-0" data-bs-toggle="tab" href="#simple-tabpanel-0" role="tab" aria-controls="simple-tabpanel-0" aria-selected="true">Daftar users</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="simple-tab-1" data-bs-toggle="tab" href="#simple-tabpanel-1" role="tab" aria-controls="simple-tabpanel-1" aria-selected="false">Tambah users</a>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content pt-4" id="tab-content">
                            ...
                            <table class="table table-striped">
                                ...
                                <?php $x=1;
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['role']; ?></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" onclick="editUser(<?= $row['id']; ?>); document.getElementById('simple-tab-2').click();">Edit</button>
                        ...
                        <div class="tab-pane" id="simple-tabpanel-1" role="tabpanel" aria-labelledby="simple-tab-1">
                            <?php
                                include_once('components/form_users.php');
                            ?>
                        </div>
                        <div class="tab-pane" id="simple-tabpanel-2" role="tabpanel" aria-labelledby="simple-tab-2">
                            <p id="editTabText" class="text-center">Silakan pilih pengguna untuk diedit.</p>
