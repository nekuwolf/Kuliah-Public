...
public class Mahasiswa {
    ...
    public String nama(String nama) {
        // this.nama = getUserInput("Masukkan nama: ");
        return nama;
    }

    public String nilai_akhir() {
        this.nilai_akhir = konversiHuruf(hitungNilai());
        return nilai_akhir;
    }

    public String konversiHuruf(float nilai) {
    ...
    public float hitungNilai() {
        ...
        return calcPercentage(nilai_tugas, 10) + calcPercentage(nilai_quiz, 10)
                + calcPercentage(((float) banyak_hadir / 14) * 100, 10)
                + calcPercentage(nilai_uts, 25) + calcPercentage(nilai_uas, 45);
    }

    public String validateRange(String value, int min_val, int max_val) {
    ...
    public float calcPercentage(float value, float percentage) {
